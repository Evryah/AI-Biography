...
import { Check, Star, ArrowRight, BookOpen, PenTool, Sparkles, ChevronRight, LogOut, Award, Briefcase } from 'lucide-react';
import { authService } from '../services/authService';
import BrandLogo from '../components/BrandLogo';

export default function PreserveStoryPage() {
  const navigate = useNavigate();
  const [selectedOption, setSelectedOption] = useState<'diy' | 'pro' | null>(null);
        ...
        {selectedOption && (
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-[#FED362] hover:bg-[#FED362]/90 active:scale-[0.99] text-slate-900 font-sans text-xs font-bold tracking-wider uppercase transition-all duration-200 shadow-md cursor-pointer"
            >
